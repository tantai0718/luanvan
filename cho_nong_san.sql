...
CREATE TABLE IF NOT EXISTS `danh_gia` (
  ...
  `phan_hoi` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `danh_gia` (`madg`, `mand`, `masp`, `so_sao`, `binh_luan`, `phan_hoi`, `ngay_danh_gia`, `ngay_phan_hoi`) VALUES
(1, 2, 1, 5, 'Xoài rất ngọt, đóng gói kỹ, giao hàng nhanh mát.', 'Cảm ơn bạn đã ủng hộ Chợ Nông Sản ạ!', '2026-06-04 16:00:00', '2026-06-04 16:30:00');
...
CREATE TABLE IF NOT EXISTS `thong_bao` (
  ...
  `hinh_anh` LONGTEXT COLLATE utf8mb4_unicode_ci NULL,
...
INSERT INTO `thong_bao` (`matb`, `mand`, `tieu_de`, `noi_dung`, `hinh_anh`, `loai`, `kich_hoat`, `da_doc`, `ngay_tao`) VALUES
(1, 2, 'Đơn hàng đã đặt thành công', 'Đơn hàng #DH1001 của bạn đã được tiếp nhận.', NULL, 'don_hang', 1, 0, '2026-06-04 10:00:00'),
(2, 1, 'Báo cáo hệ thống định kỳ', 'Hệ thống đã tự động tối ưu hóa tài nguyên tuần này.', NULL, 'he_thong', 1, 1, '2026-06-03 14:20:00');
-- --------------------------------------------------------
