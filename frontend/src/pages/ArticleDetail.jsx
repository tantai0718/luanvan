      ...
      <div className="mx-auto max-w-[1280px] px-5 pt-8 md:px-8 md:pt-12">
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-12">
          <article className="lg:col-span-8">
            ...
            {item.hinh_anh && <div className="mb-10 aspect-video overflow-hidden rounded-xl bg-background shadow-lg"><img src={resolveImg(item.hinh_anh)} alt={item.tieu_de} className="h-full w-full object-cover" /></div>}
