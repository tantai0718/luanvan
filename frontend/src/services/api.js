...
export const orderAPI = {
  ...
  adminPreorderSummaryDetail: (ngay, masp) => api.get(`/orders/admin/preorder-summary/detail?ngay=${ngay}&masp=${masp}`), 
};
...
export const subscriptionAPI = {
  ...
  adminSummaryDetail: (ngay, masp) => api.get(`/admin/subscriptions/summary/detail?ngay=${ngay}&masp=${masp}`), 
};
