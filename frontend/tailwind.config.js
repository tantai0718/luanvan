...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        "headline-lg-mobile": ["'Times New Roman'", "serif"],
        "display-lg": ["'Times New Roman'", "serif"],
        "body-md": ["'Times New Roman'", "serif"],
        "title-md": ["'Times New Roman'", "serif"],
        "headline-lg": ["'Times New Roman'", "serif"],
        "label-xs": ["'Times New Roman'", "serif"],
        "body-lg": ["'Times New Roman'", "serif"],
        "body-sm": ["'Times New Roman'", "serif"],
        "label-sm": ["'Times New Roman'", "serif"],
        "label-caps": ["'Times New Roman'", "serif"],
        "h1": ["'Times New Roman'", "serif"],
        "h2": ["'Times New Roman'", "serif"],
        "h3": ["'Times New Roman'", "serif"],
        "price": ["'Times New Roman'", "serif"]
      },
      fontSize: {
